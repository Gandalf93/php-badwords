...
<?php
    ...
    $parola = $_GET['parola']; //prendere parola da censurare nell'URL
    $censurato = str_replace($parola, '***', $discorso); //sostituire la parola censurata nel paragrafo
?>
...
<body>
    ...
    <p>la parola censurata è '<?php echo $parola ?>'</p>

    <h3>Lunghezza paragrafo censurato</h3>
    <p>Il paragrafo è composto da <?php echo strlen($censurato) ?> caratteri.</p>
